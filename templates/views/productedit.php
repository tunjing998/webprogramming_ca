<div class="container">
    ...
    <form action='<?= BASE_DIR ?>/productedit/<?= $locals['product']->getProductId() ?>' method='post' enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <input class="col-sm-3" name='product_name' value=<?= $locals['product']->getProductName() ?>><br>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="product_type">Product Type:</label>
            <input class="col-sm-3" name='product_type' value=<?= $locals['product']->getProductType() ?>><br>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="product_detail">Product Details:</label>
            <input class="col-sm-3" name='product_details' value=<?= $locals['product']->getProductDetail() ?>><br>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="product_price">Product Price:</label>
            <input class="col-sm-3" name='product_price' value=<?= $locals['product']->getProductPrice() ?>><br>
        </div>
